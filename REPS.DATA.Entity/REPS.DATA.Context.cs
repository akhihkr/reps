...
namespace REPS.DATA.Entity
{
    ...
    public partial class E4IntMgtAccEntities : DbContext
    {
        public E4IntMgtAccEntities()
            : base("name=E4IntMgtAccEntities")
        {
        }
        ...
        public virtual int PS_CreateAspNetUsers(string id, Nullable<System.DateTime> birthDate, string email, Nullable<bool> emailConfirmed, string passwordHash, string securityStamp, string phoneNumber, Nullable<bool> phoneNumberConfirmed, Nullable<bool> twoFactorEnabled, Nullable<System.DateTime> lockoutEndDateUtc, Nullable<bool> lockoutEnabled, Nullable<int> accessFailedCount, string userName, string firstname, string lastname, string sex, string question, string answer, string discriminator, Nullable<System.DateTime> dateCreated, Nullable<System.DateTime> dateModified, Nullable<bool> deleted)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PS_CreateAspNetUsers", idParameter, birthDateParameter, emailParameter, emailConfirmedParameter, passwordHashParameter, securityStampParameter, phoneNumberParameter, phoneNumberConfirmedParameter, twoFactorEnabledParameter, lockoutEndDateUtcParameter, lockoutEnabledParameter, accessFailedCountParameter, userNameParameter, firstnameParameter, lastnameParameter, sexParameter, questionParameter, answerParameter, discriminatorParameter, dateCreatedParameter, dateModifiedParameter, deletedParameter);
        }
    
        public virtual int reps_CreateAspNetUsers(string id, Nullable<System.DateTime> birthDate, string email, Nullable<bool> emailConfirmed, string passwordHash, string securityStamp, string phoneNumber, Nullable<bool> phoneNumberConfirmed, Nullable<bool> twoFactorEnabled, Nullable<System.DateTime> lockoutEndDateUtc, Nullable<bool> lockoutEnabled, Nullable<int> accessFailedCount, string userName, string firstname, string lastname, string sex, string question, string answer, string discriminator, Nullable<System.DateTime> dateCreated, Nullable<System.DateTime> dateModified, Nullable<bool> deleted)
        {
            var idParameter = id != null ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("reps_CreateAspNetUsers", idParameter, birthDateParameter, emailParameter, emailConfirmedParameter, passwordHashParameter, securityStampParameter, phoneNumberParameter, phoneNumberConfirmedParameter, twoFactorEnabledParameter, lockoutEndDateUtcParameter, lockoutEnabledParameter, accessFailedCountParameter, userNameParameter, firstnameParameter, lastnameParameter, sexParameter, questionParameter, answerParameter, discriminatorParameter, dateCreatedParameter, dateModifiedParameter, deletedParameter);
        }
    }
}
